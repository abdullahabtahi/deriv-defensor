        ...
        <header className="fixed top-0 left-0 right-0 z-50 h-[48px] bg-white border-b border-gray-200 shadow-sm flex items-center justify-between px-4">
            ...
            <div className="flex items-center gap-6">
                ...
                <Link href="/" className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-lg text-gray-900 tracking-tight">Defensor</span>
                </Link>

                {/* Primary Nav */}
                <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
                    <Link href="/" className="text-gray-900 font-bold border-b-2 border-deriv-red py-[13px]">
                        Dashboard
                    </Link>
                    <Link href="/interventions" className="hover:text-deriv-red transition-colors">
                        Intervention Log
                    </Link>
                </nav>
            </div>
